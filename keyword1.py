...
for _, row in ga and daf.iterrows():
    
    feature = {"type": "Feature", "geometry": {"type": "Point", "coordinates": [row['LOGITUDE'], row['LATITUDE']]}, "properties": {"STATION CO": row['STATION CO'],"STATION FU": row['STATION FU'],"Remarks":adfs}}
    geojson['features'].append(feature)

with open('result_keyword13.geojson', 'w') as fp:
